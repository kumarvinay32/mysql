...
class MySqlUtil {
    ...
    async commitSync() {
        try {
            if (!this.trans_id) {
                throw new Error("Transaction not initiated use beginTransaction before commit.")
            }
    ...
    async rollbackSync() {
        try {
            if (!this.trans_id) {
                throw new Error("Transaction not initiated use beginTransaction before rollback.")
            }
